...
import UpdatePasswordForm from '@/views/pages/Dashboard/Settings/Security/Partials/UpdatePasswordForm.vue'
import DashboardSettingsLayout from '@/views/layouts/Dashboard/DashboardSettingsLayout.vue'
import TwoFactorForm from '@/views/pages/Dashboard/Settings/Security/Partials/TwoFactorForm.vue'
...
<template>
    <DashboardSettingsLayout
        ...
        subheading="Update your password and security settings below."
    >
        <UpdatePasswordForm />
